---
title: ​5. Ein Diagramm freigeben
description: Ein Diagramm für andere freigeben.
...
1. Wählen Sie **Freigeben** in der oberen rechten Ecke des Diagramms aus.
   ...
   ![Dokument freigeben](../assets/share_1.png)

1. Wählen Sie das Zahnradsymbol aus, um **Einstellungen** zu öffnen, und wählen Sie **Jeder bei [Organisation] kann** anzeigen, damit jeder im Unternehmen das Diagramm mit dem Link öffnen kann.

   ![Einstellungen](../assets/share_2.png)
...
1. Aktivieren Sie **Über Suche auffindbar**, damit Mitglieder das Diagramm finden können, ohne den Link überhaupt zu benötigen.

   ![Zugriff](../assets/share_3.png)
...
1. Geben Sie eine E-Mail-Adresse direkt in das Einladungsfeld ein, um einer Person separat von der Einstellung für allgemeine Links einen personengebundenen Zugriff zu gewähren. Wählen Sie den zugehörigen Eintrag aus dem Vorschlag aus, der unter dem Feld angezeigt wird.
   ...
   ![E-Mail-Adresse eingeben](../assets/share_5.png)

1. Wählen Sie die Dropdown-Liste neben ihrem Namen aus, um **Editor** oder **Viewer** auszuwählen.

   ![Zugriffsstatus auswählen](../assets/share_6.png)
