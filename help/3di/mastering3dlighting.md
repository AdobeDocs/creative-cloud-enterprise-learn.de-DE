...
1. **Fülllicht:** weniger intensiv sind und dunklere Bereiche ausfüllen, wird dies für Bereiche verwendet, die die beiden vorherigen Lichter nicht erreichen.

   ![Beispiel eines Fülllichts, das ein 3D-Kopfhörermodell beleuchtet](assets/Mastering3dlighting_24.jpg)

Es gibt zwei Möglichkeiten, die 3-Punkt-Beleuchtung in [!DNL Dimension] - mit Richtungslichtern (einzeln zur Szene hinzufügen oder mit einer 3-Punkt-Lichtvorgabe) oder über leuchtende Objekte.

![Beispiel einer 3-Punkt-Beleuchtung in einer 3D-Szene](assets/Mastering3dlighting_25.jpg)

![Eine Softbox aus einer 3D-Beleuchtung wird in einen Rahmen, Lampen und Bildschirm zerlegt](assets/Mastering3dlighting_26.jpg)
